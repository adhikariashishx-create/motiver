"""
Django settings for motiver_backend project.
...
SECRET_KEY = 'django-insecure-lb!m0bpvswf(@ob-sfl#t!ec3ud_+b)au62g**q&aqb=z@#wmy'
...
ROOT_URLCONF = 'motiver_backend.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'main' / 'templates'],  # Add templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'motiver_backend.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'main' / 'static',  # Add static directory
]
